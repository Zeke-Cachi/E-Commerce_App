...
return (
    <div style={{backgroundColor: "green", display: "flex", flexDirection: "column"}}>
        ...
        <div style={{backgroundColor: "lightblue", display: "flex", justifyContent: "space-around",alignItems: "center"}}>{products.map((product) => {return <Product key={product.id} data={product} addToCart={addToCart} />})}</div>
